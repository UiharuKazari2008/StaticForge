...
Counts come from `node scripts/tools/generate-ws-api-docs.js`; this index keeps account bootstrap packets in `account.md` even though the generator groups them under the quips handler.
