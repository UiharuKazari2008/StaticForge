...
| Workspaces | [ws/workspace.md](./ws/workspace.md) | 35 |
| Search & tags | [ws/search.md](./ws/search.md) | 20 |
| Grimoire / Wiki | [ws/wiki.md](./ws/wiki.md) | 14 |
...
| Infrastructure | [ws/infrastructure.md](./ws/infrastructure.md) | 6 |
...
When adding client-facing endpoints, update this documentation tree (and `docs/README.md` if you add a new top-level doc category). Prefer matching `modules/ws/handlers/*.js` packet indexes and `modules/mcpAgentFacade.js` tool lists.
