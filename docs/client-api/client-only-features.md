...
| Lightbox / compare view | `public/scripts/comp/lightbox.js`, `compareViewManager.js`, `prismApplet.js` | Uses `/images/` REST for bytes. Prism is the dual-pane creative compare applet (Studio overlay/slide/loupe tools + Grid). |
