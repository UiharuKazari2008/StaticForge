...
const MCP_INSTRUCTIONS = [
    ...
    'Known or last gallery image: get_generated_image (filename, seed, or omit for latest). Never page a directory listing. Always show every generated or fetched webp to the user. Pasted Copy Lookback markdown ([label](dsap://lookback/…)): resolve_lookback — returns that item’s metadata and a grok webp for gallery images.',
