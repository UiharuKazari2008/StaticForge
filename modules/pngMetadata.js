    ...
    formatResolution(resolution, width, height) {
        ...
        if (resolution) {
            const RESOLUTIONS = [
                ...
                { value: 'normal_wallpaper_portrait', display: 'Normal Portrait Wallpaper', width: 576, height: 1024, aspect: 0.563 },
                { value: 'normal_wallpaper_landscape', display: 'Normal Widescreen Wallpaper', width: 1024, height: 576, aspect: 1.778 },
