...
async function compileDirectorPrompts(inputPrompt) {
    ...
    let processedPrompt = TextReplacements.applyTextReplacements(inputPrompt.base_input, null, inputPrompt.model);
    let processedNegativePrompt = TextReplacements.applyTextReplacements(inputPrompt.base_uc, null, inputPrompt.model);
    ...
    if (processedCharacterPrompts && Array.isArray(processedCharacterPrompts)) {
        processedCharacterPrompts = processedCharacterPrompts.map(char => {
            ...
            const processedCharPrompt = TextReplacements.applyTextReplacements(char.input, null, inputPrompt.model);
            const processedCharUC = TextReplacements.applyTextReplacements(char.uc, null, inputPrompt.model);
