...
assert.ok(getPacketScopes('vfs_rename_file').includes('vfs'));
assert.ok(getPacketScopes('vfs_delete_folder').includes('vfs'));
assert.ok(getPacketScopes('vfs_move_to_trash').includes('vfs'));
assert.ok(getPacketScopes('vfs_permanently_delete').includes('vfs'));
assert.ok(getPacketScopes('desktop_create_empty_folder').includes('vfs'));
assert.ok(getPacketScopes('workspace_bulk_add_scrap').includes('workspace'));
assert.ok(getPacketScopes('workspace_rename').includes('workspace'));
assert.ok(getPacketScopes('workspace_create_group').includes('workspace'));
assert.ok(getPacketScopes('workspace_get').includes('workspace'));
assert.ok(getPacketScopes('workspace_get_files').includes('workspace'));
assert.ok(getPacketScopes('workspace_get_scraps').includes('workspace'));
assert.ok(getPacketScopes('workspace_bulk_remove_scrap').includes('workspace'));
assert.ok(getPacketScopes('workspace_get_pinned').includes('workspace'));
assert.ok(getPacketScopes('workspace_get_groups').includes('workspace'));
...
assert.strictEqual(scopesAllowPacket(ivory, 'vfs_rename_file'), true);
assert.strictEqual(scopesAllowPacket(ivory, 'vfs_permanently_delete'), true);
assert.strictEqual(scopesAllowPacket(ivory, 'workspace_rename'), true);
assert.strictEqual(scopesAllowPacket(ivory, 'search_tags'), true);
assert.strictEqual(scopesAllowPacket(ivory, 'workspace_get_scraps'), true);
assert.strictEqual(scopesAllowPacket(ivory, 'workspace_get'), true);
assert.strictEqual(scopesAllowPacket(ivory, 'workspace_get_files'), true);
assert.strictEqual(scopesAllowPacket(ivory, 'workspace_bulk_remove_scrap'), true);
