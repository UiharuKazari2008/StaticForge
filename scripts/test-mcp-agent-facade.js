...
assert.ok(!hiddenBind.some((t) => t.name === 'run_client_js'));
assert.ok(!hiddenBind.some((t) => t.name === 'inspect_elements'));
const hiddenInspect = _test.listAdvancedToolDefs(['generation'], 'dreamscape');
assert.ok(!hiddenInspect.some((t) => t.name === 'inspect_elements'));
assert.ok(!hiddenInspect.some((t) => t.name === 'run_client_js'));
assert.ok(!hiddenInspect.some((t) => t.name === 'update_client'));
assert.ok(!hiddenInspect.some((t) => t.name === 'restart_client'));
assert.ok(genOnly.some((t) => t.name === 'run_client_js'));
assert.ok(genOnly.some((t) => t.name === 'inspect_elements'));
assert.ok(genOnly.some((t) => t.name === 'update_client'));
assert.ok(genOnly.some((t) => t.name === 'restart_client'));
assert.strictEqual(_test.rateGroupForTool('run_client_js'), 'studio');
assert.strictEqual(_test.rateGroupForTool('inspect_elements'), 'studio');
assert.strictEqual(_test.rateGroupForTool('update_client'), 'studio');
assert.strictEqual(_test.rateGroupForTool('restart_client'), 'studio');
assert.strictEqual(_test.rateGroupForCall('advanced_tools', { name: 'run_client_js' }), 'studio');
...
assert.ok(coreNames.includes('run_client_js'));
assert.ok(coreNames.includes('inspect_elements'));
assert.ok(coreNames.includes('update_client'));
assert.ok(coreNames.includes('restart_client'));
