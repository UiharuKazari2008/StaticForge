...
const hiddenClient = _test.listAdvancedToolDefs(['generation'], 'client');
assert.ok(hiddenClient.some((t) => t.name === 'inspect_elements'));
assert.ok(hiddenClient.some((t) => t.name === 'run_client_js'));
